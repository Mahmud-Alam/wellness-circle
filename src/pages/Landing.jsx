...
import TopNavbar from "../components/layout/TopNavbar"; // Import TopNavbar
...
const FEATURES = [
  {
    ...
    desc: "Browse yoga classes, meditation circles, group runs, and more — all happening right in your neighbourhood.",
  },
  {
    iconName: "users",
    title: "Join & Connect",
    desc: "Meet like-minded people in your area. Build real friendships through shared practices and movement.",
  },
  {
    iconName: "plus",
    title: "Host Your Own",
    desc: "Share your practice with the world. Create and host events that bring your local wellness community together.",
  },
];
...
const TESTIMONIALS = [
  {
    quote:
      "I went from knowing no one in my suburb to having a whole yoga crew within a month.",
    name: "Priya N.",
  ...
  {
    quote:
      "WellnessCircle made it so easy to find a morning run group. Best thing I did all year.",
    name: "James O.",
...
export default function Landing() {
  ...
  return (
    <AuthLayout>
      {/* Wrapper to constrain width on desktop and prevent stretching */}
      <div
        style={{
          maxWidth: "100%",
          margin: "0 auto",
      ...
      >
        {/* Reusable Top Navbar (Passing null user so it shows Login/Signup) */}
        <TopNavbar user={null} />

        <div className="auth-page">
          <div className="landing__accent" />

          {/* Hero + CTA desktop wrapper */}
          <div className="landing__hero-wrapper">
            {/* Hero */}
            <section className="landing__hero">
              <img
                src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=1600&h=900&fit=crop&auto=format&q=85"
              ...
              <div className="landing__hero-content">
                ...
                <p className="landing__hero-subtitle">
                  Combat loneliness. Discover, join, and host local wellness
                  events near you.
                </p>
              </div>
            </section>
            ...
            <div className="landing__cta-card">
              <div className="landing__cta-heading">
                <h2>Join your local community</h2>
                <p>
                  Discover wellness events and connect with people near you.
                </p>
              </div>

              <button
                className="btn-primary landing__primary-button"
              ...
              <button
                className="btn-secondary landing__secondary-button"
                ...
                <div key={title} className="landing__feature-card">
                  <div className="landing__feature-icon-wrap">
                    <div className="landing__feature-icon-box">
                      {Icon && (
                        <Icon size={26} color="#10B981" strokeWidth={2} />
                      )}
                    </div>
          ...
          <section className="landing__final-cta">
            ...
            <p>
              Join thousands of people already moving, meditating, and
              connecting near you.
            </p>
            <button
            ...
            <p className="landing__final-cta-note">
          ...
          <footer className="landing__footer">
            ...
            <p className="landing__footer-copy">
              © {new Date().getFullYear()} WellnessCircle Pty Ltd. All rights
              reserved.
            </p>
            <p className="landing__footer-made">
